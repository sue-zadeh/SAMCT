...
- Uploads use generated names, length limits, extension/MIME/signature validation and Office package checks. PNG/JPEG images are limited to 2 MB; documents to 5 MB. HTML/SVG and macro-enabled Office uploads are rejected. Document downloads use attachment disposition and restrictive headers.
