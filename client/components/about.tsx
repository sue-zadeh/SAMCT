...
<br /><br className= "lh-base" />This portal has been developed to improve communication between residents, Village Managers, administrators, and directors by providing a central place for important information and day-to-day operations. Residents can access village notices, documents, and maintenance services, while authorised staff can manage records, communications, and operational activities more efficiently.

<br />SAMCT Villages also supports the management of maintenance requests, purchase orders, village documentation, and other administrative processes. By bringing these services together in one secure system, the portal helps ensure information is accurate, accessible, and easy to manage.

<br />The portal currently supports the Ngatea and Whitianga village communities and is designed to strengthen communication, improve service delivery, and provide a reliable source of information for residents and staff alike.
          </p>
        </section>
      </main>
    </>
