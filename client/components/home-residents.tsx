      ...
      <main className="container py-5">
          ...
          <div className="row g-4">
            <div className="col-md-6 col-lg-4">
              <div className="p-4 border rounded-4 shadow-sm h-100 bg-white">
                ...
                <p className="text-secondary">
                  Submit a maintenance request for any issue that needs
                  attention.
                </p>
            ...
            <div className="col-md-6 col-lg-4">
              <div className="p-4 border rounded-4 shadow-sm h-100 bg-white">
                ...
                <p className="text-secondary">
                  View your previously submitted maintenance requests and track
                  their status.
                </p>
            ...
            <div className="col-md-6 col-lg-4">
              <div className="p-4 border rounded-4 shadow-sm h-100 bg-white">
                ...
                <p className="text-secondary">
                  View updates, notices, or shared documents if these are
        ...
        <section className="mb-5">
          <div className="p-4 rounded-4 border shadow-sm bg-white">
            ...
            <ul className="mb-0">
              <li>
                The exact resident features may still change once final
                requirements are confirmed.
              </li>
              <li>
                Residents may later have access to documents, notices, or extra
                forms.
              </li>
              <li>
                Maintenance may work either as a private request flow or a more
                shared system, depending on client preference.
              </li>
            </ul>
          </div>
        </section>
        ...
        <section>
          <div className="p-5 rounded-4 border shadow-sm text-center bg-white">
            ...
            <p className="text-secondary mb-4">
              Use the resident portal to send requests and keep track of
              updates.
            </p>
