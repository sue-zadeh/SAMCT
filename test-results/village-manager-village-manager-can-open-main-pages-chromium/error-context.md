...
- Name: village-manager.spec.ts >> village manager can open main pages
- Location: client/tests/e2e/village-manager.spec.ts:3:1
...
```ts
  ...
  2  | 
  3  | test('village manager can open main pages', async ({ page }) => {
...
> 6  |   await page.locator('#username').fill('village1')
  ...
  11 | 
  12 |   await page.getByRole('link', { name: /My Village/i }).click()
  13 |   await expect(page).toHaveURL(/village-manager\/my-village/)
  14 | 
  15 |   await page.getByRole('link', { name: /Maintenance/i }).click()
  16 |   await expect(page).toHaveURL(/village-manager\/maintenance/)
  17 | 
  18 |   await page.getByRole('link', { name: /Residents/i }).click()
  19 |   await expect(page).toHaveURL(/village-manager\/residents/)
  20 | })
```